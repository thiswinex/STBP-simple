...
def main():
    ...
    writer = SummaryWriter('./summaries/mnist')
    ...
    model = mnist_seq_net.to(device)
    
    #model = MNISTNet().to(device)
    
    optimizer = optim.Adam(model.parameters(), lr=args.lr)
    
    checkpoint_path = './tmp/mnist/mnist_spike.pt'
    ...
    if (args.save_model):
        torch.save(model.state_dict(), "./tmp/mnist/mnist_spike.pt")
        torch.save(model, "./tmp/mnist/mnist_spike.pth")
